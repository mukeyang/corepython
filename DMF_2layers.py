...
import math
import heapq
from processingData import read_data, get_user_item_interaction_map
...
# *****************************************************************************************************
file_name = '‪D:/dataset/Amazon/ratings.csv'
ratings, u_max_num, v_max_num = read_data(file_name)
user_map_item, latest_item_interaction, pruned_all_ratings =get_user_item_interaction_map(
    ratings, u_max_num, v_max_num)
# *****************************************************************************************************
